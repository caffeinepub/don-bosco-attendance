...
export class Backend implements backendInterface {
    ...
    async addCourse(arg0: Course): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addCourse(to_candid_Course_n1(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addLeaveEntry(arg0: LeaveEntry): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addLeaveEntry(to_candid_LeaveEntry_n5(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addTeacher(arg0: Teacher): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async approveLeave(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAttendanceByCourse(arg0: bigint): Promise<Array<AttendanceRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAttendanceByCourse(arg0);
    ...
    async getStudentsByFilter(arg0: StudentFilters): Promise<Array<Student>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStudentsByFilter(to_candid_StudentFilters_n24(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitAttendance(arg0: AttendanceSubmission): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitAttendance(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateCourse(arg0: bigint, arg1: Course): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCourse(arg0, to_candid_Course_n1(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTeacher(arg0: bigint, arg1: Teacher): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_CourseType_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CourseType): CourseType {
...
function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        courseType: from_candid_CourseType_n14(_uploadFile, _downloadFile, value.courseType)
    };
}
function from_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        sectionOrBatch: value.sectionOrBatch,
...
function from_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "practical" in value ? CourseType.practical : "theory" in value ? CourseType.theory : value;
}
...
function to_candid_Course_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Course): _Course {
    return to_candid_record_n2(_uploadFile, _downloadFile, value);
}
function to_candid_LeaveEntry_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: LeaveEntry): _LeaveEntry {
    return to_candid_record_n6(_uploadFile, _downloadFile, value);
}
function to_candid_LeaveType_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: LeaveType): _LeaveType {
    return to_candid_variant_n8(_uploadFile, _downloadFile, value);
}
function to_candid_StudentFilters_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: StudentFilters): _StudentFilters {
...
function to_candid_record_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        year: value.year,
        isActive: value.isActive,
        courseType: to_candid_CourseType_n3(_uploadFile, _downloadFile, value.courseType)
    };
}
function to_candid_record_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        batch: value.batch ? candid_some(value.batch) : candid_none()
    };
}
function to_candid_record_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        leaveType: to_candid_LeaveType_n7(_uploadFile, _downloadFile, value.leaveType),
        courseId: value.courseId
    };
}
...
function to_candid_variant_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: CourseType): {
    ...
    return value == CourseType.practical ? {
        practical: null
    } : value == CourseType.theory ? {
        theory: null
    } : value;
}
function to_candid_variant_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: LeaveType): {
    permission: null;
} | {
    leave: null;
} | {
    ...
    return value == LeaveType.permission ? {
        permission: null
